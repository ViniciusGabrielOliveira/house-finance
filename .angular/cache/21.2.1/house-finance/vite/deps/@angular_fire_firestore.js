...
function addDoc(e, t) {
  const n = __PRIVATE_cast(e.firestore, Firestore), r = doc2(e), i = __PRIVATE_applyFirestoreDataConverter(e.converter, t);
  ...
  if ("object" != typeof n[o] || __PRIVATE_isPartialObserver(n[o]) || (s = n[o++]), "QuerySnapshot" === i.bundleSource) {
    ...
    return (function __PRIVATE_onSnapshotQuerySnapshotBundle(e3, t2, n2, r2, i2) {
      ...
      return _.then((() => namedQuery(e3, t2.bundleName))).then(((e4) => {
        if (e4 && !o2) {
          i2 && e4.withConverter(i2), s2 = onSnapshot2(e4, n2 || {}, r2);
        }
...
var getCountFromServer3 = ɵzoneWrap(getCountFromServer2, true);
...
var onSnapshot3 = ɵzoneWrap(onSnapshot2, true);
...
var refEqual3 = ɵzoneWrap(refEqual2, true, 2);
